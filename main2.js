...
function generate_text_button() {
    my_tab_code = nullToEmpty(document.getElementById("song_name").value) + "_" + nullToEmpty(document.getElementById("chordsInput").value) + "_" + nullToEmpty(document.getElementById("tuningInput").value) + "_" + nullToEmpty(document.getElementById("capoInput").value) + "_" + nullToEmpty(document.getElementById("bpmInput").value) + "_" + nullToEmpty(document.getElementById("tabsbyInput").value) + "_"
    tabParts = document.getElementsByClassName("tab_parts")
    for (tpartcounter = 0; tpartcounter < tabParts.length;) {
        my_tab_code = my_tab_code + nullToEmpty(tabParts[tpartcounter].value) + "_";
        tpartcounter = tpartcounter + 1;
    }
    my_tab_code = my_tab_code + ";;;;"
        //console.log(my_tab_code);
...
function nullToEmpty(anythying) {
    if (anythying === null || anythying === undefined) {
        anythying = ''
    }
    return anythying;
}
checkClearTabs = false;

function generate_tabs_button() {
    n = 0
    o = 0
    input_tab_code = document.getElementById("generate_tabs_input").value
    if (checkClearTabs === false) {
        document.getElementById("song_name").value = input_tab_code.split("_")[0]
        document.getElementById("chordsInput").value = input_tab_code.split("_")[1]
        document.getElementById("tuningInput").value = input_tab_code.split("_")[2]
        document.getElementById("capoInput").value = input_tab_code.split("_")[3]
        document.getElementById("bpmInput").value = input_tab_code.split("_")[4]
        document.getElementById("tabsbyInput").value = input_tab_code.split("_")[5]

        tabParts = document.getElementsByClassName("tab_parts")
        for (tpartcounter = 0; tpartcounter < tabParts.length;) {
            console.log(input_tab_code.split("_")[tpartcounter + 6])
            console.log(nullToEmpty(input_tab_code.split("_")[tpartcounter + 6]))
            tabParts[tpartcounter].value = nullToEmpty(input_tab_code.split("_")[tpartcounter + 6])
            tpartcounter = tpartcounter + 1
        }


        input_tab_code = input_tab_code.split(";;;;_")[1]
        console.log(input_tab_code)
    }
...
function endTabs() {
    ...
    reset_style(x_pos[i + 1])
    reset_style(x_pos2[i + 1])
    reset_style(x_pos3[i + 1])
    reset_style(x_pos4[i + 1])
    reset_style(x_pos5[i + 1])
    reset_style(x_pos6[i + 1])

    reset_style(x_pos[i + 2])
    reset_style(x_pos2[i + 2])
    reset_style(x_pos3[i + 2])
    reset_style(x_pos4[i + 2])
    reset_style(x_pos5[i + 2])
    reset_style(x_pos6[i + 2])

    reset_style(x_pos[i + 3])
    reset_style(x_pos2[i + 3])
    reset_style(x_pos3[i + 3])
    reset_style(x_pos4[i + 3])
    reset_style(x_pos5[i + 3])
    reset_style(x_pos6[i + 3])
    ...
    document.getElementById(x_pos[i + 1]).innerHTML = 'X'
    document.getElementById(x_pos2[i + 1]).innerHTML = 'X'
    document.getElementById(x_pos3[i + 1]).innerHTML = 'X'
    document.getElementById(x_pos4[i + 1]).innerHTML = 'X'
    document.getElementById(x_pos5[i + 1]).innerHTML = 'X'
    document.getElementById(x_pos6[i + 1]).innerHTML = 'X'

    document.getElementById(x_pos[i + 2]).innerHTML = 'X'
    document.getElementById(x_pos2[i + 2]).innerHTML = 'X'
    document.getElementById(x_pos3[i + 2]).innerHTML = 'X'
    document.getElementById(x_pos4[i + 2]).innerHTML = 'X'
    document.getElementById(x_pos5[i + 2]).innerHTML = 'X'
    document.getElementById(x_pos6[i + 2]).innerHTML = 'X'

    document.getElementById(x_pos[i + 3]).innerHTML = 'X'
    document.getElementById(x_pos2[i + 3]).innerHTML = 'X'
    document.getElementById(x_pos3[i + 3]).innerHTML = 'X'
    document.getElementById(x_pos4[i + 3]).innerHTML = 'X'
    document.getElementById(x_pos5[i + 3]).innerHTML = 'X'
    document.getElementById(x_pos6[i + 3]).innerHTML = 'X'
...
function set_focus_tab_block_20() {
    ...
    var marker = document.getElementById("marker")
    marker.style.marginLeft = 0 + ".px";
    marker.style.top = 4518 + ".px";
}

function the_next() {
    i = i + 1
    var marker = document.getElementById("marker")
    if (i < 22) { marker.style.marginLeft = i * 45 + ".px"; } else if (i < 44) {
        marker.style.marginLeft = (i - 22) * 45 + ".px";
        marker.style.top = 270 + ".px";
    } else if (i < 66) {
        marker.style.marginLeft = (i - 44) * 45 + ".px";
        marker.style.top = 506 + ".px";
    } else if (i < 88) {
        marker.style.marginLeft = (i - 66) * 45 + ".px";
        marker.style.top = 742 + ".px";
    } else if (i < 110) {
        marker.style.marginLeft = (i - 88) * 45 + ".px";
        marker.style.top = 978 + ".px";
    } else if (i < 132) {
        marker.style.marginLeft = (i - 110) * 45 + ".px";
        marker.style.top = 1214 + ".px";
    } else if (i < 154) {
        marker.style.marginLeft = (i - 132) * 45 + ".px";
        marker.style.top = 1450 + ".px";
    } else if (i < 176) {
        marker.style.marginLeft = (i - 154) * 45 + ".px";
        marker.style.top = 1686 + ".px";
    } else if (i < 198) {
        marker.style.marginLeft = (i - 176) * 45 + ".px";
        marker.style.top = 1922 + ".px";
    } else if (i < 220) {
        marker.style.marginLeft = (i - 198) * 45 + ".px";
        marker.style.top = 2158 + ".px";
    } else if (i < 242) {
        marker.style.marginLeft = (i - 220) * 45 + ".px";
        marker.style.top = 2394 + ".px";
    } else if (i < 264) {
        marker.style.marginLeft = (i - 242) * 45 + ".px";
        marker.style.top = 2630 + ".px";
    } else if (i < 286) {
        marker.style.marginLeft = (i - 264) * 45 + ".px";
        marker.style.top = 2866 + ".px";
    } else if (i < 308) {
        marker.style.marginLeft = (i - 286) * 45 + ".px";
        marker.style.top = 3102 + ".px";
    } else if (i < 330) {
        marker.style.marginLeft = (i - 308) * 45 + ".px";
        marker.style.top = 3338 + ".px";
    } else if (i < 352) {
        marker.style.marginLeft = (i - 330) * 45 + ".px";
        marker.style.top = 3574 + ".px";
    } else if (i < 374) {
        marker.style.marginLeft = (i - 352) * 45 + ".px";
        marker.style.top = 3810 + ".px";
    } else if (i < 396) {
        marker.style.marginLeft = (i - 374) * 45 + ".px";
        marker.style.top = 4046 + ".px";
    } else if (i < 418) {
        marker.style.marginLeft = (i - 396) * 45 + ".px";
        marker.style.top = 4282 + ".px";
    } else if (i < 440) {
        marker.style.marginLeft = (i - 418) * 45 + ".px";
        marker.style.top = 4518 + ".px";
    }
...
function the_prev() {
    ...
    var marker = document.getElementById("marker")
    if (i < 22) {
        marker.style.marginLeft = i * 45 + ".px";
        marker.style.top = 30 + ".px";
    } else if (i < 44) {
        marker.style.marginLeft = (i - 22) * 45 + ".px";
        marker.style.top = 270 + ".px";
